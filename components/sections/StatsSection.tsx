      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => {
            ...
            return (
              ...
              >
                <div className={`inline-flex p-4 rounded-full bg-[#101826] border border-gray-700 mb-4 group-hover:border-opacity-100 transition-colors duration-300`}>
        ...
        <div className="mt-16 text-center">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="p-6 bg-[#101826] rounded-lg border border-gray-700">
              <div className="text-2xl font-bold text-[#22C55E] mb-2">50+</div>
              <div className="text-gray-300">Apps Delivered</div>
            </div>
            <div className="p-6 bg-[#101826] rounded-lg border border-gray-700">
              <div className="text-2xl font-bold text-[#66E3FF] mb-2">100%</div>
              <div className="text-gray-300">Client Satisfaction</div>
            </div>
            <div className="p-6 bg-[#101826] rounded-lg border border-gray-700">
              <div className="text-2xl font-bold text-[#A78BFA] mb-2">24/7</div>
              <div className="text-gray-300">Deployment Uptime</div>
            </div>
          </div>
        </div>
      </div>
